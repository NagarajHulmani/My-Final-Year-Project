...
// $ret="SELECT * FROM tblbooking where FromPlace and(:fromdate BETWEEN date(FromDate) and date(ToDate) || :todate BETWEEN date(FromDate) and date(ToDate) || date(FromDate) BETWEEN :fromdate and :todate) and VehicleId=:vhid";
$ret = "SELECT * FROM tblbooking WHERE 
        FromPlace = :fromplace AND 
        ToPlace = :toplace AND
...
$query1->bindParam(':fromplace',$fromplace,PDO::PARAM_STR);
$query1->bindParam(':toplace',$toplace,PDO::PARAM_STR);
...
$sql="INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromPlace,ToPlace,FromDate,ToDate,message,Status) VALUES(:bookingno,:useremail,:vhid,:fromplace,:toplace,:fromdate,:todate,:message,:status)";
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <div class="form-group">
              <label>From :</label>
              <input type="text" class="form-control" name="fromplace" placeholder="Enter place" required>
            </div>
            <div class="form-group">
              <label>To:</label>
              <input type="text" class="form-control" name="toplace" placeholder="Enter place" required>
            </div>
            <div class="form-group">
