...
if (strlen($_SESSION['login']) == 0) {
  ...
  <head>
    ...
    <title>Car Rental System - My Booking</title>
    <!--Bootstrap -->
                      ...
                      foreach ($results as $result) { ?>
                        ...
                        <li>
                          ...
                          <div class="vehicle_title">
                            ...
                            <h6><a href="vehical-details.php?vhid=<?php echo htmlentities($result->vid); ?>"> <?php echo htmlentities($result->BrandName); ?> , <?php echo htmlentities($result->VehiclesTitle); ?></a>
                            </h6>
                      

                            <p><b>From: </b>
                              <?php echo htmlentities($result->FromPlace); ?></br>
                              <b>To: </b><?php echo htmlentities($result->ToPlace); ?>
                            </p>
                          ...
                          <?php } else if ($result->Status == 2) { ?>
                            ...
                            <?php } else { ?>
                              <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Not Confirm yet</a>
                                <div class="clearfix"></div>
                                <div class=payment>
                                  <small><p><a href="payment/userpayment.php">Payment Now</a></p></small>
                                </div>
                                <!-- <div class="cancel">
                                  <p><a href="cancel_rent.php">Cancel Booking</a></p>
                                </div> -->
                              </div>
                            <?php } ?>
                        ...
                        <table>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php echo htmlentities($result->FromPlace); ?>
                            </td>
                            <td>
                            <?php echo htmlentities($result->ToPlace); ?>
                            </td>
                            <td>
