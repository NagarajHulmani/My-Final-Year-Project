...
document.getElementById("paymentForm").addEventListener("submit", function(event) {
  ...
  if (googlepayId.trim() === "") {
    alert("Please enter Google Pay UPI ID");
  } else {
    // Perform Google Pay UPI payment processing here
    alert("Google Pay UPI payment successful!");
...
<body>
  <div class="container">
    <h1>Google Pay UPI Payment</h1></br>
    ...
    <form id="paymentForm" class="payment-form" action="payment_fail.php">
      <div id="upiDetails" class="input-group">
        ...
        <input type="text" id="googlepayId" placeholder="Google Pay UPI ID">
      </div>
