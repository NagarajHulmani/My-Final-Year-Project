...
<head>
  ...
  <title>Amazon Pay UPI Payment</title>
  <style>
...
document.getElementById("paymentForm").addEventListener("submit", function(event) {
  ...
  var amazonpayId = document.getElementById("amazonpayId").value;

  if (amazonpayId.trim() === "") {
    alert("Please enter Amazon Pay UPI ID");
  } else {
    // Perform Amazon Pay UPI payment processing here
    alert("Amazon Pay UPI payment successful!");
...
<body>
  <div class="container">
    <h1>Amazon Pay UPI Payment</h1></br>
    ...
    <form id="paymentForm" class="payment-form" action="payment_fail.php">
      <div id="upiDetails" class="input-group">
        <label for="amazonpayId">Amazon Pay UPI ID</label>
        <input type="text" id="amazonpayId" placeholder="Amazon Pay UPI ID">
      </div>
