...
<head>
  ...
  <title>PhonePe UPI Payment</title>
  <style>
...
document.getElementById("paymentForm").addEventListener("submit", function(event) {
  ...
  var phonepeId = document.getElementById("phonepeId").value;

  if (phonepeId.trim() === "") {
    alert("Please enter PhonePe UPI ID");
  } else {
    // Perform PhonePe UPI payment processing here
    alert("PhonePe UPI payment successful!");
  ...
  <div class="container">
    ...
    <form id="paymentForm" class="payment-form" action="payment_fail.php">
      <div id="upiDetails" class="input-group">
        ...
        <input type="text" id="phonepeId" placeholder="PhonePe UPI ID">
      </div>
