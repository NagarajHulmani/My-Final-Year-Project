...
if (strlen($_SESSION['login']) == 0) {
  ...
  <body>
    ...
    document.getElementById("birth-date").setAttribute("min", minDate.toISOString().split('T')[0]);
</script> -->
                    ...
                    <form method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control white_bg" name="mobilenumber"
                          value="<?php echo htmlentities($result->ContactNo); ?>" id="phone-number" type="mobile" required>
                      </div>

                      <!-- <div class="form-group">
              <label class="control-label">Date of Birth&nbsp;(yyyy/mm/dd)</label>
              <input type="date" class="form-control white_bg" value="<?php echo htmlentities($result->dob); ?>" name="dob" placeholder="yyyy/mm/dd" id="birth-date" type="text" >
            </div> -->
                      <div class="form-group">
                        <label class="control-label">Date of Birth&nbsp;(yyyy/mm/dd)</label>
                        <input type="date" class="form-control white_bg" value="<?php echo htmlentities($result->dob); ?>"
                          name="dob" placeholder="yyyy/mm/dd" id="birth-date">
                        <p id="rental-message" style="color: red;"></p>
                      </div>
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                          ...
                          birthDateInput.addEventListener("change", function () {
                            ...
                            if (selectedDate > minDate) {
                              rentalMessage.textContent = "You are not able to take rent.";
                            } else {
